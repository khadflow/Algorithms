public class Gaussian {
	...
	public int[][] multiply(Gaussian B) {
	...
	public static void main(String args[]) {
		...
		*/
		...
		Gaussian A_matrix = new Gaussian(A);
		Gaussian B_matrix = new Gaussian(B);
		...
		A_matrix = new Gaussian(A);
		B_matrix = new Gaussian(B);
